...
cmd /c electron-packager src CloudEdu --overwrite --platform=win32 --arch=x64 --version=1.4.11 --out=Staging --version-string.ProductName=CloudEdu --version-string.ProductVersion=0.1.6
